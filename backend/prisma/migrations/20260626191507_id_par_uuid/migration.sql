/*
  ...
  - The primary key for the `leitura` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - The primary key for the `plantacao` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - The primary key for the `plantacao_sensor` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
INSERT INTO "new_usuario" ("criado_em", "email", "id", "nome", "senha", "telefone") SELECT "criado_em", "email", "id", "nome", "senha", "telefone" FROM "usuario";
DROP TABLE "usuario";
